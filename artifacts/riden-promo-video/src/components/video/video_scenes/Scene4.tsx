...
export function Scene4() {
  return (
    ...
    >
      ...
      <div className="z-10 w-full h-full flex flex-col justify-center items-center text-center" dir="rtl">
        <motion.div
          className="relative w-[12vw] h-[12vw] rounded-full border-[4px] border-[var(--color-accent-gold)] flex items-center justify-center mb-8 shadow-[0_0_50px_rgba(255,179,0,0.3)] bg-black/50 backdrop-blur-sm"
          initial={{ scale: 0, opacity: 0 }}
          animate={{ scale: 1, opacity: 1 }}
          transition={{ delay: 0.8, type: "spring", stiffness: 150, damping: 20 }}
        >
          <motion.svg
            className="w-[6vw] h-[6vw] text-[var(--color-accent-gold)]"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            strokeWidth={3}
